...
function Footer() {
  return (
    <div className="max-w-screen flex h-64 flex-col items-center justify-center gap-12 bg-fem-550 font-barlow font-semibold">
      <a
        href="#placeholder"
        className="scale-150 duration-400 hover:scale-[160%]"
      >
      ...
      <ul className="flex gap-8 ">
        <li className="">
          <a
            href="#placeholder"
            className="text-fem-500 duration-400 hover:text-fem-50"
          >
            About
          </a>
        </li>
      ...
      <ul className="flex gap-4 text-2xl text-fem-500">
        <li className="inline-block">
          <a href="#placeholder" className="p-2 duration-400 hover:text-fem-50">
